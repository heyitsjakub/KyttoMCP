...
[![Version](https://img.shields.io/badge/beta-1.0.3.1-blue)](https://github.com/heyitsjakub/KyttoMCP/releases)
...
```sh
# macOS
shasum -a 256 KyttoMCP-1.0.3.1.dmg
# 2e7a2b0944a0159bbd3a3f452a9c45028e048e262d4b15d828b683f700d0eb0a

# Windows (PowerShell)
Get-FileHash Kytto-Setup-win-x64-1.0.3.1.exe -Algorithm SHA256
# 55811ea0be9a6a554b964e50abcf9de9c6292ff3a23e8ab1e40eadbfd989f262
```
...
Proprietary. Free to use during the 1.0.3.1 beta.
